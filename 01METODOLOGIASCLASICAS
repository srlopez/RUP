...
- [Desventajas de las metodologías de desarrollo](#desventajas-de-las-metodologías-de-desarrollo)
...
### Ciclo de vida 
Cuando se habla de metodologías de desarrollo es inevitable no asociarlo a su pieza mas transcendente y fundamental, el _“ciclo de vida”_. El concepto de ciclo de vida ha ocasionado siempre bastante confusión debido a que existen numerosas definiciones e interpretaciones de éste, y son muchos los autores que lo han particularizado y nombrado bajo su criterio y punto de vista. A “Toda compañía debería trabajar duro para hacer que su propia línea de productos quede obsoleta, antes de que lo haga competencia”. - Philip Kotler.  
...
* **Codificación o Implementación**. Una vez finalizado el producto, se presenta al cliente. Se le muestra su funcionamiento y rendimiento y se debate si se ha llegado a conseguir la idea y requisitos que se estaban buscando, consiguiendo de esta forma la satisfacción por ambas partes.   
...
Propuesto por Alan Davis a principios de los 90. Se base en el modelo en cascada con la innovación de rocurar actividades de pruebas más efectivas y productivas mediante la introducción de validaciones en la medida en que se avanza en el proyecto; dado que en el modelo tradicional las pruebas se introducían al final los defectos aparecían en forma tardía. Las pruebas necesitan empezarse lo más pronto posible en el ciclo de vida y estas actividades deberían ser llevadas a cabo en paralelo con las actividades de desarrollo.
...
## Desventajas de las metodologías de desarrollo
Cómo se ha podido ver, las metodologías tradicionales presentan numerosos inconvenientes que limitan su funcionamiento en el actual marco laboral. El **modelo de cascada** se caracteriza por ser un modelo **muy rígido**, que no permite retroceder ni avanzar etapas a conveniencias del dasarrollador. Al ser un método secuencial, obliga a finalizar una fase para poder pasar a la siguiente. Además, el producto no es presentando al cliente hasta su completo desarrollo, sin dar posibilidad de testeo ni evaluación durante su desarrollo. Todo esto se traduce en un continuo estado de incertidumbre e inseguridad, que en un mercado como el actual, donde el cliente se muestra indeciso y exigente, supone a las empresas correr un riesgo innecesario y con un alto precio a pagar. El **modelo en V** tiene como objetivo solventar ese **estado de inseguridad** a través de continuas evaluaciones y pruebas que se realizan a la par que el desarrollo del producto, pero sigue siendo un método que no puede hacer frente a decisiones impredecibles y fortuitas del cliente, puesto que sigue tratándose de un proceso secuencial sin posibilidad de cambio hasta su finalización. Por su parte, el **modelo de espiral** mejora las desventajas anteriores al tratarse de un proceso iterativo y que permite la repetición de las etapas hasta que ambas partes, clientes y desarrolladores, estén conformes con el producto final. No obstante, se corre el riesgo de entrar en **bucles demasiado largos y costosos** por no llegar a un acuerdo que contente a las dos partes. Además, este método reclama un equipo de trabajo muy competente y cualificado que sea capaz de responder a las necesidades y cambios que exijan los clientes. Todo esto conlleva unos procesos de formación que añaden más gastos aún a la gestión del desarrollo. Debido a la poca competitividad que estos métodos ofrecen a las actuales empresas, éstas se han visto obligadas a reinvertarse y buscar otras alternativas que les ofrezcan más oportunidades de subsistir y progresar en su desarrollo industrial. De ésta forma, se da lugar a la aparición de nuevos métodos más competentes en los años posteriores.
